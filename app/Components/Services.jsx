      ...
      >
        {serviceData.map(({ icon, title, description, link }, index) => (
          <motion.div
            ...
            key={index}
            className="border border-gray-400 rounded-lg px-8 py-10 hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1.5 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white"
          >
