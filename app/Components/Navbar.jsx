      ...
      >
        ...
        <ul
          className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 ${
            isScroll
              ? ""
              : " bg-white shadow-sm bg-opacity-50 dark:border data:border-white/50 dark:bg-transparent"
          }`}
        >
          <li>
        ...
        <ul
          ref={sideMenuRef}
          className="flex flex-col gap-4 py-20 top-0 bottom-0  w-64 z-50 h-screen bg-rose-50 transition duration-500 px-10 fixed -right-64 md:hidden
